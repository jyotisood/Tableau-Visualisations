...
##### This workbook uses the Global Superstore Sample dataset of tableau to create a Dynamic Regional Sales Dashboard. Feel free to use it for sales and product analysis by region. This dashboard presents a resource to understand the profit, loss, sales and product categories and quantities bought by region and the major cities in that region. 
